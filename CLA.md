...
This repository requires all contributors to sign a CLA before their
contributions can be merged. The CLA Assistant bot will prompt you
when you open a pull request.

Individual contributors (contributing on your own behalf) must agree
to the **Individual Agreement** below. Contributors acting on behalf
of a company or other legal entity must agree to the **Entity
Agreement**.

---

## Part I — Individual Contributor Assignment Agreement
Harmony Individual Contributor Assignment Agreement

Thank you for your interest in contributing to occt-rs (\"We\"
or \"Us\").

This contributor agreement (\"Agreement\") documents the rights granted
by contributors to Us. To make this document effective, sign via the
automated CLA Assistant bot, which will prompt you when you open a pull
request at <https://github.com/occt-rs/occt-rs>.
...
to Us in which You own or assert ownership of the Copyright. Do not
submit work you do not own the copyright to. If you believe your
contribution includes third-party work, open an issue before submitting
a PR describing the provenance.
...
such rights covering the Contribution, with rights to sublicense through
multiple tiers of sublicensees, to reproduce, modify, display, perform,
and distribute the Contribution. The intention of the parties is that
this license will be as broad as possible and to provide You with rights
as similar as possible to the owner of the rights that You transferred.
...
As a condition on the grant of rights in Sections 2.1 and 2.2, We agree to license the Contribution only under the terms of the following licenses:
(a) AGPL-3.0-or-later, for public distribution; and
(b) a proprietary commercial license, granting the copyright holder of this project a perpetual, worldwide, non-exclusive, royalty-free, irrevocable right to use, modify, and distribute the Contribution as part of proprietary software without the conditions of the AGPL-3.0-or-later.
No other licenses are granted by this Agreement. The copyright holder may transfer the rights received under this Agreement to a successor organisation, provided that successor agrees in writing to be bound by these same outbound license conditions.
...
2.6 Reservation of Rights. Any rights not expressly assigned or licensed
under this section are expressly reserved by You.
...
\(d\) You have followed the instructions for signing via the CLA
Assistance bot, if You do not own the Copyright in the entire work of
...
the laws of France excluding its conflicts of law provisions. Under
...
## Part II — Entity Contributor Assignment Agreement


Harmony Entity Contributor Assignment Agreement

Thank you for your interest in contributing to occt-rs (\"We\" or
\"Us\").

This contributor agreement (\"Agreement\") documents the rights granted
by contributors to Us. To make this document effective, sign via the
automated CLA Assistant bot, which will prompt you when you open a pull
request at <https://github.com/occt-rs/occt-rs>. This is a legally
binding document, so please read it carefully before agreeing to it. The
...
\(b\) You or Your Affiliates own the Copyright and patent claims
covering the Contribution which are required to grant the rights under
Section 2.
...
This CLA is derived from the Harmony Contributor Agreement template (harmonyagreements.org), licensed under CC-BY 3.0.
